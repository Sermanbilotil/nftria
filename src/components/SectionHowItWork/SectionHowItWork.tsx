...
const DEMO_DATA = [
  {
    ...
    desc: "Connect wallet to be able to create and trade your beautiful NFTs",
  },
  {
    id: 2,
    img: HIW2img,
    ...
    desc: "Upload model in application, set up lights and make screenshot",
  },
  {
    id: 3,
    img: HIW3img,
    imgDark: HIW3img,
    title: "Start trading",
    desc: "Mint your VR suitable NFTs and show the whole world what you got",
  },
  {
    id: 4,
    img: HIW4img,
    imgDark: HIW4img,
    title: "Earn money",
    desc: "Sell your NFTs or use our refferal program to gain Lifetime rewards",
  },
];
