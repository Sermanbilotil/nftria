      ...
      <Popover className="relative">
        {({ open }) => (
          <>
            ...
            >
              <Avatar
                imgUrl={currentUserData.photoSrc || ProfileIcon}
                          ...
                          <div className="relative grid grid-cols-1 gap-6 bg-white dark:bg-neutral-800 py-7 px-6">
                              <div className="flex items-center space-x-3">
                                  ...
                                  <div className="flex-grow">
                                      ...
                                      <p className="text-xs mt-0.5">{shortEth}</p>
                                  </div>
                              </div>
                              ...
                              <Link
                                   to={{pathname: `/page-author/${currentUserData.ethAddress}`, state: {
                                      ethAddress: currentUserData.ethAddress
                                  },}}
                                  onClick={() => close()}
