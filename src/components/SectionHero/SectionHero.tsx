...
import rightImg from "images/vr-main-page.png";
...
const SectionHero: FC<SectionHeroProps> = ({
  className = "",
  heading = "syka blyat, collect, and sell extraordinary NFTs ",
  subHeading = "Upload your 3D models and showcase them in VR. Convert models to NFTs and start earning.",
}) => {
  return (
    <div
